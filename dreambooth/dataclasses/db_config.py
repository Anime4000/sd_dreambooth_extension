...
class DreamboothConfig(BaseModel):
	...
	dream_detail_preservation: float = 0.4
	...
	graph_smoothing: int = 25
	half_model: bool = True
	has_ema: bool = False
	hflip: bool = False
	...
	loss_curve_scale: float = 0.5
	lr_cycles: int = 1
	lr_factor: float = 0.5
	lr_power: float = 1.0
	lr_scale_pos: float = 0.5
	lr_scheduler: str = "rex"
	...
	model_path: str = ""
	model_type: str = "v1x"
	noise_scheduler: str = "DEIS"
	num_train_epochs: int = 80
	offset_noise: float = 0
	offset_rand_max: float = 1.1
	offset_rand_min: float = 0.9
	offset_sched: float = -0.0157    
	optimizer: str = "8bit AdamW"
	pad_tokens: bool = True
	pretrained_model_name_or_path: str = ""
	pretrained_vae_name_or_path: str = ""
	prior_loss_scale: bool = True
	prior_loss_target: int = 60
	prior_loss_weight: float = 0.25
	prior_loss_weight_min: float = 0.15
	resolution: int = 512
	revision: int = 0
	...
	save_ema: bool = False
	save_embedding_every: int = 0
	save_lora_after: bool = True
	save_lora_cancel: bool = False
	save_lora_during: bool = False
	save_lora_for_extra_net: bool = False
	save_preview_every: int = 0
	...
	txt_learning_rate: float = 3.75e-7
